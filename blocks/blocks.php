...
function b_ventrilo_do_block()
{
    $sites = [
        'Strathnet' => 'http://strathnet.cable.nu',
        "Beefy's World" => 'http://www.beefysworld.com',
        'PlanetAMD64' => 'http://www.planetamd64.com',
        'NodeDB' => 'http://www.nodedb.com/index.php?country=australia&state=vic&city=bendigo',
        'E3' => 'http://www.e3.com.au/',
        'Land Chanel Map' => 'http://services.land.vic.gov.au/landchannel/jsp/TermsAndConditions.jsp?serviceName=interactivemap',
        'DVD Collection' => 'http://www.intervocative.com/DVDCollection.aspx/kheldaroz',
        'Land Chanel Map' => 'http://services.land.vic.gov.au/landchannel/jsp/TermsAndConditions.jsp?serviceName=interactivemap',
    ];
